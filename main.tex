...
%-------------------------------------------------------------------------------
		...
		\begin{frame}				
			...
			\begin{figure}[htb]
				\begin{center}
					\colorbox{white}{\includegraphics[height=150pt]{img/blueprint.png}}
					\label{fig:blueprint}
				\end{center}
			\end{figure}		
...
%-------------------------------------------------------------------------------
		...
		\begin{frame}
			...
			\begin{columns}
				...
				\centering
				\colorbox{white}{\includegraphics[height=120pt]{img/eda.png}}
...
%-------------------------------------------------------------------------------
		...
		\begin{frame}
			...
			\begin{figure}[htb]
				\begin{center}
					\colorbox{white}{\includegraphics[height=135pt]{img/bench.png}}
					\label{fig:blueprint}
				\end{center}
			\end{figure}	
...
%-------------------------------------------------------------------------------
			...
			\begin{frame}
				...
				\begin{columns}
					...
					\column{0.5\linewidth}
					\centering
					\colorbox{white}{\includegraphics[height=120pt]{img/fe.png}}
...
%-------------------------------------------------------------------------------	
			...
			\begin{frame}
				...
				\begin{columns}
					...
					\column{0.5\linewidth}
					\centering
					\colorbox{white}{\includegraphics[height=120pt]{img/pre.png}}
					...
					\begin{itemize}
						...
						\item \textbf{Roadmap items for H2O.ai MLI}.
					\end{itemize}
...
%-------------------------------------------------------------------------------			
			...
			\begin{frame}
				...
				\begin{columns}
					...
					\column{0.5\linewidth}
					\centering
					\colorbox{white}{\includegraphics[height=120pt]{img/im.png}}
					...
					\begin{itemize}
						...
						\item \textbf{LIME-SUP, SBRL, XNN are roadmap items for H2O.ai MLI}.
					\end{itemize}
...
%-------------------------------------------------------------------------------			
			...
			\begin{frame}
				...
				\begin{columns}			
					...
					\column{0.5\linewidth}
					\centering
					\colorbox{white}{\includegraphics[height=120pt]{img/ma.png}}
...
%-------------------------------------------------------------------------------			
			...
			\begin{frame}
				...
				\begin{columns}
					...
					\column{0.5\linewidth}
					\centering
					\colorbox{white}{\includegraphics[height=120pt]{img/exp.png}}
					...
					\begin{itemize}
						...
						\item Tree SHAP is roadmap for H2O-3; \textbf{Explanations for unstructured data are roadmap for H2O.ai MLI}.
					\end{itemize}}
...
%-------------------------------------------------------------------------------	
			...
			\begin{frame}
				...
				\begin{columns}
					...
					\column{0.5\linewidth}
					\centering
					\colorbox{white}{\includegraphics[height=120pt]{img/md.png}}
					...
					\footnotesize{\begin{itemize}
						...
						\item \textbf{Adversarial examples, explanation of residuals, measures of epistemic uncertainty, ``what-if'' analysis are roadmap items in H2O.ai MLI.}
...
%-------------------------------------------------------------------------------					
			...
			\begin{columns}
				...
				\column{0.5\linewidth}
				\centering
				\colorbox{white}{\includegraphics[height=120pt]{img/fair.png}}
				...
				\begin{itemize}
					...
					\item \textbf{Disparate impact analysis and remediation are roadmap items for H2O.ai MLI.}
				\end{itemize}
...
%-------------------------------------------------------------------------------
		...
		\begin{frame}
			...
			\begin{columns}
				...
				\column{0.5\linewidth}
				\centering
				\colorbox{white}{\includegraphics[height=120pt]{img/hr.png}}
...
%-------------------------------------------------------------------------------
		...
		\begin{frame}
			...
			\begin{columns}
				...
				\column{0.5\linewidth}
				\centering
				\colorbox{white}{\includegraphics[height=120pt]{img/deploy.png}}
...
%-------------------------------------------------------------------------------
		...
		\begin{frame}	
			...
			\begin{figure}[htb]
				\begin{center}
					\colorbox{white}{\includegraphics[height=135pt]{img/ha.png}}
					\label{fig:blueprint}
				\end{center}
			\end{figure}	
...
%-------------------------------------------------------------------------------
		...
		\begin{frame}	
			...
			\begin{figure}[htb]
				\begin{center}
					\colorbox{white}{\includegraphics[height=135pt]{img/iter.png}}
					\label{fig:blueprint}
				\end{center}
			\end{figure}	
...
%-------------------------------------------------------------------------------
	...
	\begin{frame}[t, allowframebreaks]
		...
		\frametitle{References}
			...
			\small{\url{https://github.com/navdeep-G/gtc-2019/blob/master/main.pdf}}
					
			\vspace{10pt}	
					
			\textbf{Driverless AI API Interpretability Technique Examples:}\\
			\small{\url{https://github.com/h2oai/driverlessai-tutorials/tree/master/interpretable_ml}}
			...
			\textbf{More In-Depth Open Source Interpretability Technique Examples:}\\
			\small{\url{https://github.com/navdeep-G/interpretable-ml}}
